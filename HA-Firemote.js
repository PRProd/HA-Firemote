...
class FiremoteCard extends LitElement {
  ...
  static styles = css`
          ...
          #volume-up-button:active, #volume-down-button:active {
  ...
  `;
   ...
   render() {
    ...
    if(stateStr == 'playing' && appId != 'com.amazon.firebat' && appId != 'com.android.systemui' &&
                                ...
                                appId != 'com.nvidia.shieldtech.accessoryui') {
